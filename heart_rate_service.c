 ...
 *  Private Data Types
 *============================================================================*/
/*JDP, may need to include information about where the sensor data is stored
  similar to how the batter data is stored in NVM below at nvm_offset*/
...
/*JDP, may need a g_snsr_serv_data*/
...
extern void HeartRateSendMeasValue(uint16 ucid, uint8 hrm_length, 
                                   uint8 *p_hr_meas)
{
    /*JDP, may need to do this sort of send notification of new
      sensor data being presented to the app*/
...
extern void HeartRateHandleAccessRead(GATT_ACCESS_IND_T *p_ind)
{
    ...
    switch(p_ind->handle)
    {
        /*JDP, may need to have this send the sensor data!*/
