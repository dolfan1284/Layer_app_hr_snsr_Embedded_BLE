...
#define HANDLE_DEVICE_INFO_SERVICE_END  (0x0021)
...
#define HANDLE_POS_SENSOR_SERVICE       (0x0022)
#define HANDLE_POS_SENSOR_SERVICE_END   (0xffff)
#define ATTR_LEN_POS_SENSOR_SERVICE     (2)
#define HANDLE_POS_LOC_LEVEL            (0x0024)
#define ATTR_LEN_POS_LOC_LEVEL          (1)
#define HANDLE_POS_LOC_LEVEL_C_CFG      (0x0025)
#define ATTR_LEN_POS_LOC_LEVEL_C_CFG    (0)
