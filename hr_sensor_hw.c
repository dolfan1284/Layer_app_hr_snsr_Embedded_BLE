...
/*JDP, add all the IO information from the multi-hardcoded motor project here*/
...
{
    /*JDP, setup initial values for PIO here*/
...
{
    /*JDP, change this from the multi-hardcoded motor project to
      allow the button press possibly!*/
